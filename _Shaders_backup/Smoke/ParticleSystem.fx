...
technique11 T0
{
    pass P0
    {          
        SetVertexShader( CompileShader( vs_5_0, RenderParticlesToSceneDSLightingVS() ) );
        SetGeometryShader( NULL );
        SetHullShader( CompileShader( hs_5_0, RenderParticlesToSceneDSLightingHS() ) );
        SetDomainShader( CompileShader( ds_5_0, RenderParticlesToSceneDSLightingDS() ) );
        SetPixelShader( CompileShader( ps_5_0, RenderSoftParticlesToSceneVSDSLighting() ) );
...
technique11 T1
{
    pass P0
    {          
        SetVertexShader(CompileShader(vs_5_0, RenderParticlesToOpacityVS()));
        SetGeometryShader( NULL );
        SetHullShader( NULL );
        SetDomainShader( NULL );
        SetPixelShader( CompileShader( ps_5_0, RenderParticlesToOpacityPS() ) );
