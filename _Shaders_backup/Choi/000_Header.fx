...
//[maxvertexcount(9)]
//void GS_Depth(triangle MeshOutput input[3], inout TriangleStream<GeometryOutput1> stream)//정점 하나를 받아서 gs에서 정점 4개로만들어서 면을 만든다.
//{
...
//        output[k].Position = ViewProjection(output[k].Position); //sv_position은 레스터라이징될 포지션(화면에 나갈포지션)
