...
public:
	...
	static void OpenFileDialog(wstring file, const WCHAR* filter, wstring folder, uint num, class Material* material,function<void(wstring, uint,Material*)> func, HWND hwnd = NULL);
