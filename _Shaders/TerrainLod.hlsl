...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local0 = dot(Parameters.TexCoords[0].xy, MaterialFloat2(-0.00000000, 1.00000000));
	MaterialFloat Local1 = dot(Parameters.TexCoords[0].xy, MaterialFloat2(1.00000000, 0.00000000));
	MaterialFloat2 Local2 = (1.00000000 * MaterialFloat2(Local1, Local0));
	MaterialFloat2 Local3 = (Local2 + MaterialFloat2(0.00000000, 0.00000000));
	MaterialFloat2 Local4 = (Local3 / Material.ScalarExpressions[0].x);
	MaterialFloat2 Local5 = (Local4 * Material.ScalarExpressions[0].y);
	MaterialFloat2 Local6 = (Material.ScalarExpressions[0].z * Local5);
	MaterialFloat Local7 = MaterialStoreTexCoordScale(Parameters, Local6, 6);
	MaterialFloat4 Local8 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material.Texture2D_0, GetMaterialSharedSampler(Material.Texture2D_0Sampler, View.MaterialTextureBilinearWrapedSampler), Local6));
	MaterialFloat Local9 = MaterialStoreTexSample(Parameters, Local8, 6);
	MaterialFloat2 Local10 = (Local4 * Material.ScalarExpressions[0].w);
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, Local10, 6);
	MaterialFloat4 Local12 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material.Texture2D_0, GetMaterialSharedSampler(Material.Texture2D_0Sampler, View.MaterialTextureBilinearWrapedSampler), Local10));
	MaterialFloat Local13 = MaterialStoreTexSample(Parameters, Local12, 6);
	MaterialFloat3 Local14 = ResolvedView.WorldCameraOrigin;
	MaterialFloat3 Local15 = (Local14 - GetWorldPosition(Parameters));
	MaterialFloat Local16 = dot(Local15, Local15);
	MaterialFloat Local17 = sqrt(Local16);
	MaterialFloat Local18 = (Local17 * Material.ScalarExpressions[1].z);
	MaterialFloat Local19 = (1.00000000 - Local18);
	MaterialFloat Local20 = (Local19 * (1.00000000 / max((1.00000000 - 0.00000000), 0.00001000)));
	MaterialFloat Local21 = min(max(Local20, 0.00000000), 1.00000000);
	MaterialFloat Local22 = (1.00000000 - Local21);
	MaterialFloat4 Local23 = lerp(Local8.rgba, Local12.rgba, MaterialFloat(Local22));
	MaterialFloat Local24 = (Local23.a + 0.00000000);
	MaterialFloat Local25 = saturate(Local24);
	MaterialFloat Local26 = lerp((0.00000000 - 0.00000000), (0.00000000 + 1.00000000), Local25);
	MaterialFloat Local27 = min(max(Local26, 0.00000000), 1.00000000);
	MaterialFloat Local28 = lerp(-1.00000000, 1.00000000, 1.00000000);
	MaterialFloat Local29 = (Local28 + Local27.r);
	MaterialFloat Local30 = min(max(Local29, 0.00010000), 1.00000000);
	MaterialFloat Local31 = (0.00000000 + Local30);
	MaterialFloat2 Local32 = (Material.ScalarExpressions[2].x * Local5);
	MaterialFloat Local33 = MaterialStoreTexCoordScale(Parameters, Local32, 6);
	MaterialFloat4 Local34 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material.Texture2D_1, GetMaterialSharedSampler(Material.Texture2D_1Sampler, View.MaterialTextureBilinearWrapedSampler), Local32));
	MaterialFloat Local35 = MaterialStoreTexSample(Parameters, Local34, 6);
	MaterialFloat4 Local36 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material.Texture2D_1, GetMaterialSharedSampler(Material.Texture2D_1Sampler, View.MaterialTextureBilinearWrapedSampler), Local10));
	MaterialFloat Local37 = MaterialStoreTexSample(Parameters, Local36, 6);
	MaterialFloat4 Local38 = lerp(Local34.rgba, Local36.rgba, MaterialFloat(Local22));
	MaterialFloat Local39 = (Local38.a + Material.ScalarExpressions[2].y);
	MaterialFloat Local40 = saturate(Local39);
	MaterialFloat Local41 = lerp(Material.ScalarExpressions[2].w, Material.ScalarExpressions[2].z, Local40);
	MaterialFloat Local42 = min(max(Local41, 0.00000000), 1.00000000);
	MaterialFloat2 Local43 = (Material.ScalarExpressions[3].y * Local5);
	MaterialFloat Local44 = MaterialStoreTexCoordScale(Parameters, Local43, 6);
	MaterialFloat4 Local45 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material.Texture2D_2, GetMaterialSharedSampler(Material.Texture2D_2Sampler, View.MaterialTextureBilinearWrapedSampler), Local43));
	MaterialFloat Local46 = MaterialStoreTexSample(Parameters, Local45, 6);
	MaterialFloat4 Local47 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material.Texture2D_2, GetMaterialSharedSampler(Material.Texture2D_2Sampler, View.MaterialTextureBilinearWrapedSampler), Local10));
	MaterialFloat Local48 = MaterialStoreTexSample(Parameters, Local47, 6);
	MaterialFloat4 Local49 = lerp(Local45.rgba, Local47.rgba, MaterialFloat(Local22));
	MaterialFloat Local50 = (Local49.a + Material.ScalarExpressions[3].z);
	MaterialFloat Local51 = saturate(Local50);
	MaterialFloat Local52 = lerp(Material.ScalarExpressions[4].x, Material.ScalarExpressions[3].w, Local51);
	MaterialFloat Local53 = min(max(Local52, 0.00000000), 1.00000000);
	MaterialFloat2 Local54 = (Material.ScalarExpressions[4].z * Local5);
	MaterialFloat Local55 = MaterialStoreTexCoordScale(Parameters, Local54, 6);
	MaterialFloat4 Local56 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material.Texture2D_3, GetMaterialSharedSampler(Material.Texture2D_3Sampler, View.MaterialTextureBilinearWrapedSampler), Local54));
	MaterialFloat Local57 = MaterialStoreTexSample(Parameters, Local56, 6);
	MaterialFloat4 Local58 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material.Texture2D_3, GetMaterialSharedSampler(Material.Texture2D_3Sampler, View.MaterialTextureBilinearWrapedSampler), Local10));
	MaterialFloat Local59 = MaterialStoreTexSample(Parameters, Local58, 6);
	MaterialFloat4 Local60 = lerp(Local56.rgba, Local58.rgba, MaterialFloat(Local22));
	MaterialFloat Local61 = (Local60.a + Material.ScalarExpressions[4].w);
	MaterialFloat Local62 = saturate(Local61);
	MaterialFloat Local63 = lerp(Material.ScalarExpressions[5].y, Material.ScalarExpressions[5].x, Local62);
	MaterialFloat Local64 = min(max(Local63, 0.00000000), 1.00000000);
	MaterialFloat2 Local65 = (Material.ScalarExpressions[5].w * Local5);
	MaterialFloat Local66 = MaterialStoreTexCoordScale(Parameters, Local65, 6);
	MaterialFloat4 Local67 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material.Texture2D_4, GetMaterialSharedSampler(Material.Texture2D_4Sampler, View.MaterialTextureBilinearWrapedSampler), Local65));
	MaterialFloat Local68 = MaterialStoreTexSample(Parameters, Local67, 6);
	MaterialFloat4 Local69 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material.Texture2D_4, GetMaterialSharedSampler(Material.Texture2D_4Sampler, View.MaterialTextureBilinearWrapedSampler), Local10));
	MaterialFloat Local70 = MaterialStoreTexSample(Parameters, Local69, 6);
	MaterialFloat4 Local71 = lerp(Local67.rgba, Local69.rgba, MaterialFloat(Local22));
	MaterialFloat Local72 = (Local71.a + Material.ScalarExpressions[6].x);
	MaterialFloat Local73 = saturate(Local72);
	MaterialFloat Local74 = lerp(Material.ScalarExpressions[6].z, Material.ScalarExpressions[6].y, Local73);
	MaterialFloat Local75 = min(max(Local74, 0.00000000), 1.00000000);
	MaterialFloat2 Local76 = (Material.ScalarExpressions[6].w * Local5);
	MaterialFloat Local77 = MaterialStoreTexCoordScale(Parameters, Local76, 6);
	MaterialFloat4 Local78 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material.Texture2D_5, GetMaterialSharedSampler(Material.Texture2D_5Sampler, View.MaterialTextureBilinearWrapedSampler), Local76));
	MaterialFloat Local79 = MaterialStoreTexSample(Parameters, Local78, 6);
	MaterialFloat4 Local80 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material.Texture2D_5, GetMaterialSharedSampler(Material.Texture2D_5Sampler, View.MaterialTextureBilinearWrapedSampler), Local10));
	MaterialFloat Local81 = MaterialStoreTexSample(Parameters, Local80, 6);
	MaterialFloat4 Local82 = lerp(Local78.rgba, Local80.rgba, MaterialFloat(Local22));
	MaterialFloat Local83 = (Local82.a + 0.00000000);
	MaterialFloat Local84 = saturate(Local83);
	MaterialFloat Local85 = lerp((0.00000000 - 0.00000000), (0.00000000 + 1.00000000), Local84);
	MaterialFloat Local86 = min(max(Local85, 0.00000000), 1.00000000);
	MaterialFloat2 Local87 = (Material.ScalarExpressions[7].x * Local5);
	MaterialFloat Local88 = MaterialStoreTexCoordScale(Parameters, Local87, 6);
	MaterialFloat4 Local89 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material.Texture2D_6, GetMaterialSharedSampler(Material.Texture2D_6Sampler, View.MaterialTextureBilinearWrapedSampler), Local87));
	MaterialFloat Local90 = MaterialStoreTexSample(Parameters, Local89, 6);
	MaterialFloat4 Local91 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material.Texture2D_6, GetMaterialSharedSampler(Material.Texture2D_6Sampler, View.MaterialTextureBilinearWrapedSampler), Local10));
	MaterialFloat Local92 = MaterialStoreTexSample(Parameters, Local91, 6);
	MaterialFloat4 Local93 = lerp(Local89.rgba, Local91.rgba, MaterialFloat(Local22));
	MaterialFloat Local94 = (Local93.a + 0.00000000);
	MaterialFloat Local95 = saturate(Local94);
	MaterialFloat Local96 = lerp((0.00000000 - 0.00000000), (0.00000000 + 1.00000000), Local95);
	MaterialFloat Local97 = min(max(Local96, 0.00000000), 1.00000000);
	MaterialFloat Local98 = (1.00000000 / Local31);
	MaterialFloat Local99 = MaterialStoreTexCoordScale(Parameters, Local6, 8);
	MaterialFloat4 Local100 = UnpackNormalMap(Texture2DSample(Material.Texture2D_7, GetMaterialSharedSampler(Material.Texture2D_7Sampler, View.MaterialTextureBilinearWrapedSampler), Local6));
	MaterialFloat Local101 = MaterialStoreTexSample(Parameters, Local100, 8);
	MaterialFloat Local102 = MaterialStoreTexCoordScale(Parameters, Local10, 8);
	MaterialFloat4 Local103 = UnpackNormalMap(Texture2DSample(Material.Texture2D_7, GetMaterialSharedSampler(Material.Texture2D_7Sampler, View.MaterialTextureBilinearWrapedSampler), Local10));
	MaterialFloat Local104 = MaterialStoreTexSample(Parameters, Local103, 8);
	MaterialFloat3 Local105 = lerp(Local100.rgb, Local103.rgb, MaterialFloat(Local22));
	MaterialFloat2 Local106 = (Local105.rg * Material.ScalarExpressions[7].y);
	MaterialFloat Local107 = (Local98 * Local30);
	MaterialFloat3 Local108 = (MaterialFloat3(Local106, 1.00000000) * Local107);
	MaterialFloat3 Local109 = (0.00000000 + Local108);

    // The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = Local109.rgb;
	...
	MaterialFloat3 Local110 = lerp(MaterialFloat3(0.00000000, 0.00000000, 0.00000000), Material.VectorExpressions[1].rgb, MaterialFloat(Material.ScalarExpressions[7].z));
	MaterialFloat Local111 = MaterialStoreTexCoordScale(Parameters, Local6, 7);
	MaterialFloat4 Local112 = ProcessMaterialColorTextureLookup(Texture2DSample(Material.Texture2D_8, GetMaterialSharedSampler(Material.Texture2D_8Sampler, View.MaterialTextureBilinearWrapedSampler), Local6));
	MaterialFloat Local113 = MaterialStoreTexSample(Parameters, Local112, 7);
	MaterialFloat Local114 = MaterialStoreTexCoordScale(Parameters, Local10, 7);
	MaterialFloat4 Local115 = ProcessMaterialColorTextureLookup(Texture2DSample(Material.Texture2D_8, GetMaterialSharedSampler(Material.Texture2D_8Sampler, View.MaterialTextureBilinearWrapedSampler), Local10));
	MaterialFloat Local116 = MaterialStoreTexSample(Parameters, Local115, 7);
	MaterialFloat3 Local117 = lerp(Local112.rgb, Local115.rgb, MaterialFloat(Local22));
	MaterialFloat3 Local118 = (1.00000000 - Local117);
	MaterialFloat3 Local119 = (Local118 * 2.00000000);
	MaterialFloat3 Local120 = (Local119 * Material.VectorExpressions[4].rgb);
	MaterialFloat3 Local121 = (1.00000000 - Local120);
	MaterialFloat3 Local122 = (Local117 * 2.00000000);
	MaterialFloat3 Local123 = (Local122 * Material.VectorExpressions[3].rgb);
	MaterialFloat Local124 = ((Local117.r >= 0.50000000) ? Local121.r : Local123.r);
	MaterialFloat Local125 = ((Local117.g >= 0.50000000) ? Local121.g : Local123.g);
	MaterialFloat Local126 = ((Local117.b >= 0.50000000) ? Local121.b : Local123.b);
	MaterialFloat3 Local127 = (MaterialFloat3(MaterialFloat2(Local124, Local125), Local126) * Local107);
	MaterialFloat3 Local128 = (0.00000000 + Local127);
	MaterialFloat3 Local129 = (1.00000000 - Local128.rgb);
	MaterialFloat3 Local130 = (Local129 * 2.00000000);
	MaterialFloat Local131 = MaterialStoreTexCoordScale(Parameters, Local4, 0);
	MaterialFloat4 Local132 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material.Texture2D_9, Material.Texture2D_9Sampler, Local4, View.MaterialTextureMipBias));
	MaterialFloat Local133 = MaterialStoreTexSample(Parameters, Local132, 0);
	MaterialFloat3 Local134 = lerp(MaterialFloat3(0.50000000, 0.50000000, 0.50000000), Local132.rgb, MaterialFloat(Material.ScalarExpressions[7].w));
	MaterialFloat3 Local135 = (1.00000000 - Local134);
	MaterialFloat3 Local136 = (Local130 * Local135);
	MaterialFloat3 Local137 = (1.00000000 - Local136);
	MaterialFloat3 Local138 = (Local128.rgb * 2.00000000);
	MaterialFloat3 Local139 = (Local138 * Local134);
	MaterialFloat Local140 = ((Local128.rgb.r >= 0.50000000) ? Local137.r : Local139.r);
	MaterialFloat Local141 = ((Local128.rgb.g >= 0.50000000) ? Local137.g : Local139.g);
	MaterialFloat Local142 = ((Local128.rgb.b >= 0.50000000) ? Local137.b : Local139.b);
	MaterialFloat Local143 = (Local23.b * Local107);
	MaterialFloat Local144 = (0.00000000 + Local143);
	MaterialFloat Local145 = (Material.ScalarExpressions[8].x + Local23.g);
	MaterialFloat Local146 = saturate(Local145);
	MaterialFloat Local147 = (Local146 * Local107);
	MaterialFloat Local148 = (0.00000000 + Local147);

	PixelMaterialInputs.EmissiveColor = Local110;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = MaterialFloat3(MaterialFloat2(Local140, Local141), Local142);
	PixelMaterialInputs.Metallic = Local144.r;
	PixelMaterialInputs.Specular = 0.10000000;
	PixelMaterialInputs.Roughness = Local148.r;
...
{
#if COMPILER_DXC && COMPILER_VULKAN
